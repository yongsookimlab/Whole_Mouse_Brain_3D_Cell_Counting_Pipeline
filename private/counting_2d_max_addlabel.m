function [] = counting_2d_max_addlabel(images_in_folder, images_out_folder,targeting_folder, xyz_resolution, targeting_resolution, brain_xyz_orientation)
...
parfor jj = 1:length(nmz_in_tif_list)
    ...
    flagg = (img_out_temp(indd) == 3) | (img_out_temp(indd) == 5); % set multiple trained classifier values for counting.
