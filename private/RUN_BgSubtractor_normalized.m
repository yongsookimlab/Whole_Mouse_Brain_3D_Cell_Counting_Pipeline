function [] = RUN_BgSubtractor_normalized(normalized_images_folder, normalized_bg_images_folder, normalization_ratio)

%% input
signal_directory = normalized_images_folder;
noise_directory = normalized_bg_images_folder;
