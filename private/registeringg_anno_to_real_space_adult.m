function [] = registeringg_anno_to_real_space_adult(folder_name, allen_back,allen_anno)
% clear
%%%  %Settings
...
para_elastx_0 = strcat(pwd, '/elastix/parameter_adult/001_parameters_Rigid.txt'); % parameter_1
para_elastx_1 = strcat(pwd, '/elastix/parameter_adult/002_parameters_BSpline.txt'); % parameter_2
