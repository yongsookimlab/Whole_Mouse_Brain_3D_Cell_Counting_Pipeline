function [] = heatmap_using_index_file_area(rev_elastix_working_folder,loaded_nii,allen_anno)
...
trans_location = accumarray(trans_location, loaded_nii(logi), [tiff_info(1).Height,tiff_info(1).Width, length(tiff_info)]);
